'''
Polycarp có ba chị em: Alice, Barbara và Cerene. Họ đang thu thập tiền xu. Hiện tại, Alice có một đồng tiền, 
Barbara có tiền xu và Cerene có tiền xu. Gần đây Polycarp đã trở về từ chuyến đi vòng quanh thế giới và mang theo n xu.
...
Nói cách khác, nếu Polycarp đưa A xu cho Alice, B xu cho Barbara và C xu cho Cerene (A + B + C = n), thì a + A = b + B = c + C. 
...
Điều kiện đủ : Sau khi chia thì mỗi người có lượng tiền >= lượng tiền ban đầu của họ. 
Ví dụ test 1 1 9 1 dù chia hết cho 3 nhưng ko thỏa mãn vì khi đó phải lấy tiền của 3 người đưa cho nhau.
